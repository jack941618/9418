...
export const modelConfigs = [
  ...
  },
  {
    ...
    apiKey: process.env.ARK_API_KEY,  // 请确保环境变量 ARK_API_KEY 已设置
    baseURL: "https://ark.cn-beijing.volces.com/api/v3"
  },
  {
    model: "hunyuan-turbos-latest",
    apiKey: process.env.HUNYUAN_API_KEY,  // 请确保环境变量 HUNYUAN_API_KEY 已设置
    baseURL: "https://api.hunyuan.cloud.tencent.com/v1"
  },
  {
    model: "doubao-1-5-lite-32k-250115", // 豆包模型 | 火山引擎接入点（改成自己的）
    apiKey: process.env.ARK_API_KEY,      // 如果使用火山引擎，可共用 ARK_API_KEY
    baseURL: "https://ark.cn-beijing.volces.com/api/v3"
  },
  {
    model: "ep-20250306223646-szzkw",      // deepseekv 火山引擎接入点（改成自己的）
    apiKey: process.env.ARK_API_KEY,      // 可共用 ARK_API_KEY 或单独设置
    baseURL: "https://ark.cn-beijing.volces.com/api/v3"
  },
  {
    model: "glm-4-air",
    apiKey: process.env.GLM_API_KEY,      // 请确保环境变量 GLM_API_KEY 已设置
    baseURL: "https://open.bigmodel.cn/api/paas/v4/"
  },
  {
    model: "deepseek-chat",
    apiKey: process.env.DEEPSEEK_API_KEY, // 请确保环境变量 DEEPSEEK_API_KEY 已设置
    baseURL: "https://api.deepseek.com/v1"
  },
  {
    model: "moonshot-v1-8k",
    apiKey: process.env.KIMI_API_KEY,     // 请确保环境变量 KIMI_API_KEY 已设置
    baseURL: "https://api.moonshot.cn/v1"
  },
  {
    model: "ernie-3.5-128k",
    apiKey: process.env.BAIDU_API_KEY,    // 请确保环境变量 BAIDU_API_KEY 已设置
